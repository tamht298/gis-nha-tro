                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row table-responsive mx-auto" style="font-size: 16px">
                            ...
                            @else
                            <div class="text-center"><i>Chưa có bài viết để hiện thị. Nhấn vào đây<button class="btn btn-success mt-2 float-right mr-3" data-toggle="modal" data-target="#addModalBaiViet"> để tạo bài viết. </i></div>
                            @endif
                        </div>
