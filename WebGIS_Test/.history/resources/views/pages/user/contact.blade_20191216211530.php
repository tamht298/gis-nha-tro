                    ...
                    <form action="send-email" method="get">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="sdt" class="form-control" id="inputPassword4">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="tieude" class="form-control" id="inputCity">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="inputCity">Email<span class="text-danger"> (*)</span></label>
                                <input type="email" name="" class="form-control" id="inputCity">
                            </div>
