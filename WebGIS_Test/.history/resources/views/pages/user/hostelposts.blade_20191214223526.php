                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row table-responsive mx-auto" style="font-size: 16px">
                            ...
                            @else
                            <div class="text-center"><i>Chưa có bài viết để hiện thị. Nhấn <a class="text-blue" data-toggle="modal" data-target="#addModalBaiViet">vào đây</a> để tạo bài viết. </i></div>
                            @endif
                        </div>
