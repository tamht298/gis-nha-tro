        ...
        <div class="container-fluid dashboard-content ">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="navbar-nav col-3 float-right rounded rounded-pill">
                        <div id="custom-search" class="top-search-bar input-group">
                            <input class="form-control" type="text" placeholder="Nhập tên hoặc mssv">
