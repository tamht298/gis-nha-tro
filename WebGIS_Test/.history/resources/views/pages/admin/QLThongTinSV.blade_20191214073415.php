                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><form  action="thong-tin-tro" class="mb-0" method="post">
                                        ...
                                        <input type="submit" class="btn btn-link" style="font-size: 1rem" value="{{$item->ho}} {{$item->ten}}" data-toggle="tooltip" data-html="true"
                                        data-placement="left" title="Chi tiết quá trình trọ">
                                        </button>
                                            </form>
                                            </td>
                                    <td>{{$item->lop}}</td>
