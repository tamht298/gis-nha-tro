                                                        ...
                                                        <form action="{{ route('SuaNT',['gid' => $nhatro->gid])}}"
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-form-label font-weight-bold">Địa
                                                                    chỉ:</label>
                                                                    <textarea class="form-control"name="diachi" value={{$nhatro->diachi}}>

                                                                    </textarea>
                                                                <input type="text" value="{{$nhatro->diachi}}"
                                                                     class="form-control">
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-form-label font-weight-bold">Số điện
                                                                    thoại:</label>
                                                                <input type="text" value="{{$nhatro->sodienthoa}}"
