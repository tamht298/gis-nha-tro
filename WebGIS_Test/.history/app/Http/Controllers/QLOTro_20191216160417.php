...
class QLOTro extends Controller
{
    ...
    public function DSSVTro(Request $req)
    {
        ...
        $SVOTro=DB::table('otro')->where('makhutro', $idkhutro, 'otro')->join('khunhatro_tdm_point', 'otro.makhutro', '=', 'khunhatro_tdm_point.gid','khunhatro_tdm_point', 'otro.makhutro', '=', 'khunhatro_tdm_point.gid')->paginate($pageSize);
