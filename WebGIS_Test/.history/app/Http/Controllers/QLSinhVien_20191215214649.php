...
class QLSinhVien extends Controller
{
    ...
    public function search(Request $req){
        ...
        $student= DB::table('sinhvien')->where('mssv', 'like', '%{$search}%')->orWhere('ten', 'like', '%{$search}%')->paginate(5);
        return ('pages.admin.QLThongTinSV',['student'=>$student, 'pageSize'=>$pageSize]);
    }
}
