...
class QLOTro extends Controller
{
    ...
    public function DSSVTro(Request $req)
    {
        ...
        $SVOTro=DB::table('otro')->where('makhutro', $idkhutro)->join('khunhatro_tdm_point', 'otro.makhutro', '=', 'khunhatro_tdm_point.gid','khunhatro_tdm_point', 'otro.makhutro', '=', 'khunhatro_tdm_point.gid')->where()->paginate($pageSize);
