            ...
            <script>
                    ...
                    var popup = L.popup();
                        function onMapClick(e)
                        {
                            popup
                            .setLatLng(e.latlng)
                            .setContent("<form class='form-group' action='themNhakhutro' method='POST'> <input type='hidden' name='_token' value='<?php echo csrf_token(); ?>'> Tên nhà trọ:<br> <input type='text' class='form-control' required style='height: 1%;' name='txtTennhatro'> <br> Tên chủ trọ:<br> <input type='text' class='form-control' required style='height: 1%;' name='txtTenchutro'> <br> Điện thoại:<br> <input type='text' class='form-control' required style='height: 1%;' name='txtSodienthoai'> <br> Địa chỉ:<br> <input type='text' class='form-control' required style='height: 1%;' name='txtDiachi'> <br><input type='hidden' name='x' value='"+e.latlng.lng+"' > <br><input type='hidden' name='y' value='"+e.latlng.lat+"'><input type='submit' class='btn btn-success btn-xs form-control' name='txtThem' value='Thêm Khu Trọ'> <br></form>" + e.latlng.toString())
                            .openOn(map);
